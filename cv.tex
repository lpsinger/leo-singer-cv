...
Goddard Space Flight Center, Building 34\\ % Your address
Greenbelt, \textsc{md} 20771 \textsc{u.s.a.}\\[.2cm]
\end{minipage}\begin{minipage}[t][2cm][s]{5cm}
{\tiny\faEnvelopeAlt} \,\,\,\,\,\, \href{mailto:lsinger@caltech.edu}{\small \texttt{leo.singer@ligo.org}}\\
...
\years{2014}(defended) Ph.D. in Physics, California Institute of Technology\\
...
\years{2014}\href{http://dx.doi.org/10.1088/0004-637X/795/2/105}{\textbf{Singer, L.}, Price, L. R., Farr, B., Urban, A. L., Pankow, C., Vitale, S., Veitch, J., Farr, W. M., Hanna, C., Cannon, K., Downes, T., Graff, P., Haster, C.-J., Mandel, H., Sidery, T. and Vecchio, A., “The First Two Years of Electromagnetic Follow-Up with Advanced LIGO and Virgo", \emph{Astrophysical Journal} 795: 105}\\[0.125cm]
%
...
\years{2014}\textbf{Singer, L.} \emph{et al.}, “The Needle in the 100\,deg$^2$ Haystack: Uncovering Afterglows of \emph{Fermi} GRBs with the Palomar Transient Factory"\\[0.125cm]
%
\years{2014}\textbf{Singer, L.} and Price, L., “WHOOMP! (There It Is): Rapid Bayesian Position Reconstruction for Gravitational-Wave Transients"

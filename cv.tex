...
\setmonofont[Scale=0.8]{NotoSansMono-Regular} % Set mono font (e.g. phone numbers)
...
Greenbelt, MD 20771\end{minipage}\begin{minipage}[t][2cm][s]{5cm}{\small\faEnvelope} \,\,\, \href{mailto:leo.p.singer@nasa.gov}{\small \texttt{leo.p.singer@nasa.gov}}\\
